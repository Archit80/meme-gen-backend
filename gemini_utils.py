    ...
    **Wholesome Mode:**  
    ...
    """
        ...
        **Savage Mode (Brutal Honesty):**  
        - DARK, brutal, offensive, NSFW humor using controversial topics of current times like Bihari's, Muslims, Christians, Hindu, BJP, politics, social issues, or toxic traits
